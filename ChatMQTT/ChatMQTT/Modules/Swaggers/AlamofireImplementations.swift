...
private var managerStore: [String: AlamofireDomain.SessionManager] = [:]
...
open class AlamofireRequestBuilder<T>: RequestBuilder<T> {
    ...
    /**
     ...
     configuration.
     */
    open func createSessionManager() -> AlamofireDomain.SessionManager {
        let configuration = URLSessionConfiguration.default
        configuration.httpAdditionalHeaders = buildHeaders()
        return AlamofireDomain.SessionManager(configuration: configuration)
    }
    ...
    override open func execute(_ completion: @escaping (_ response: Response<T>?, _ error: Error?) -> Void) {
        ...
        let xMethod = AlamofireDomain.HTTPMethod(rawValue: method)
